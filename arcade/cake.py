...
class MyGame(arcade.Window):
    ...
    def setup(self):
        ...
        # Create the player
        self.cake1 = arcade.Sprite("Previews/cherries.png", SPRITE_SCALING_PLAYER)
        self.cake1.center_x = 50
        self.cake1.center_y = 64
        self.player_list.append(self.cake1)

        self.cake2 = arcade.Sprite("Previews/cake-birthday.png", SPRITE_SCALING_PLAYER)
        self.cake2.center_x = 250
        self.cake2.center_y = 500
        self.player_list.append(self.cake2)

        self.cake3 = arcade.Sprite("Previews/cookie-chocolate.png", SPRITE_SCALING_PLAYER)
